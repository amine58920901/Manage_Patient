...
public class SecurityServiceImpl implements SecurityService {
    ...
    public AppUser saveNewUser(String username, String password, String rePassword) {
        ...
        String hashedPWD=passwordEncoder.encode(password); // pour hacher le mot de passe.
        AppUser appUser=  new AppUser();
        appUser.setUserId(UUID.randomUUID().toString()); // permet de genérer de identifiant en string (UUID)
